...
<f:message bundle="${locale}" key="locale.enterPersonName" var="localeEnterPersonName"/>
<f:message bundle="${locale}" key="locale.enterPlaceOfBirth" var="localeEnterPlaceOfBirth"/>
...
<main class="container">
    ...
    <div class="jumbotron">
        <ul class="nav nav-tabs">
            <li class="active"><a href="Controller?command=add-person">EN</a></li>
        </ul>
        <form action="Controller?command=add-person" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input name="personFormDateOfBirth" value="${requestScope.personFormDateOfBirth}" type="date" class="form-control" id="date-of-birth">
            </div>
            <div class="form-group">
