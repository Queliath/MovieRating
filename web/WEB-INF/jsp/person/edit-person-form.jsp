...
<f:message bundle="${locale}" key="locale.personForm" var="localePersonForm"/>
    ...
    <c:if test="${requestScope.person != null}">
        <div class="jumbotron">
            <ul class="nav nav-tabs">
                <li <c:if test='${requestScope.editingLanguage eq "EN"}'>class="active"</c:if>><a href="Controller?command=edit-person&id=${requestScope.person.id}">EN</a></li>
                <li <c:if test='${requestScope.editingLanguage eq "RU"}'>class="active"</c:if>><a href="Controller?command=edit-person&id=${requestScope.person.id}&lang=RU">RU</a></li>
            </ul>
            <form method="post" role="form">
                ...
                <c:if test='${requestScope.editingLanguage eq "EN"}'>
                    <div class="form-group">
                        ...
                        <input name="personFormDateOfBirth" value="${requestScope.person.dateOfBirth}" type="date" class="form-control" id="date-of-birth">
                    </div>
                </c:if>
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="personFormDateOfBirth" value="${requestScope.person.dateOfBirth}" type="hidden">
                </c:if>
                <div class="form-group">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="personFormPhoto" value="${requestScope.person.photo}" type="hidden">
                </c:if>
                <div class="form-group">
