        ...
        <div class="jumbotron">
            ...
            <form method="post" role="form">
                <div class="form-group">
                    ...
                    <input name="countryFormName" value="${requestScope.country.name}" type="text" class="form-control" id="name">
                </div>
                <c:if test='${requestScope.editingLanguage eq "EN"}'>
                    <div class="form-group">
                        <label for="position">${localePosition}</label>
                        <input name="countryFormPosition" value="${requestScope.country.position}" type="number" class="form-control" id="position">
                    </div>
                </c:if>
