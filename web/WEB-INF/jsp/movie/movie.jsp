        ...
        <div class="jumbotron">
            ...
            <div class="clearfix">
                ...
                <ul>
                    ...
                    <c:if test='${requestScope.movie.producers != null || sessionScope.userStatus eq "admin"}'><li>${localeProducers}: <c:forEach items="${requestScope.movie.producers}" var="producer"><a href="#">${producer.name}</a> <c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" data-toggle="modal" data-target="#remove-modal"><span class="glyphicon glyphicon-remove"></span></a> </c:if></c:forEach><c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" class="btn btn-success btn-xs">${localeAddProducer}</a></c:if></li></c:if>
                    <c:if test='${requestScope.movie.writers != null || sessionScope.userStatus eq "admin"}'><li>${localeWriters}: <c:forEach items="${requestScope.movie.writers}" var="writer"><a href="#">${writer.name}</a> <c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" data-toggle="modal" data-target="#remove-modal"><span class="glyphicon glyphicon-remove"></span></a> </c:if></c:forEach><c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" class="btn btn-success btn-xs">${localeAddWriter}</a></c:if></li></c:if>
                    ...
                    <c:if test='${requestScope.movie.operators != null || sessionScope.userStatus eq "admin"}'><li>${localeOperators}: <c:forEach items="${requestScope.movie.operators}" var="operator"><a href="#">${operator.name}</a> <c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" data-toggle="modal" data-target="#remove-modal"><span class="glyphicon glyphicon-remove"></span></a> </c:if></c:forEach><c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" class="btn btn-success btn-xs">${localeAddOperator}</a></c:if></li></c:if>
                    <c:if test='${requestScope.movie.editors != null || sessionScope.userStatus eq "admin"}'><li>${localeEditors}: <c:forEach items="${requestScope.movie.editors}" var="editor"><a href="#">${editor.name}</a> <c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" data-toggle="modal" data-target="#remove-modal"><span class="glyphicon glyphicon-remove"></span></a> </c:if></c:forEach><c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" class="btn btn-success btn-xs">${localeAddEditor}</a></c:if></li></c:if>
                    <c:if test='${requestScope.movie.composers != null || sessionScope.userStatus eq "admin"}'><li>${localeComposers}: <c:forEach items="${requestScope.movie.composers}" var="composers"><a href="#">${composers.name}</a> <c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" data-toggle="modal" data-target="#remove-modal"><span class="glyphicon glyphicon-remove"></span></a> </c:if></c:forEach><c:if test='${sessionScope.userStatus eq "admin"}'><a href="#" class="btn btn-success btn-xs">${localeAddComposer}</a></c:if></li></c:if>
