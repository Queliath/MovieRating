...
<f:message bundle="${locale}" key="locale.addNewCountry" var="localeAddNewCountry"/>
                        ...
                        <c:if test='${sessionScope.userStatus eq "admin"}'>
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="Controller?command=countries">${countriesPageName}</a></li>
                                </ul>
                            </li>
                        </c:if>
                    </c:if>
...
<main class="container">
    ...
    <div id="country-remove-modal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="Controller?command=delete-country" method="post">
