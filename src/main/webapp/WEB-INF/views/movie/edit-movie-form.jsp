    ...
    <c:if test="${requestScope.movie != null}">
        <div class="jumbotron">
            <ul class="nav nav-tabs">
                <li <c:if test='${requestScope.editingLanguage eq "EN"}'>class="active"</c:if>><a href="Controller?command=edit-movie&id=${requestScope.movie.id}">EN</a></li>
                <li <c:if test='${requestScope.editingLanguage eq "RU"}'>class="active"</c:if>><a href="Controller?command=edit-movie&id=${requestScope.movie.id}&lang=RU">RU</a></li>
            </ul>
            <form method="post" role="form">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="movieFormYear" value="${requestScope.movie.year}" type="hidden">
                </c:if>
                <div class="form-group">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="movieFormBudget" value="${requestScope.movie.budget}" type="hidden">
                </c:if>
                <c:if test='${requestScope.editingLanguage eq "EN"}'>
                    <div class="form-group">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="movieFormPremiere" value="${requestScope.movie.premiere}" type="hidden">
                </c:if>
                <c:if test='${requestScope.editingLanguage eq "EN"}'>
                    <div class="form-group">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="movieFormLasting" value="${requestScope.movie.lasting}" type="hidden">
                </c:if>
                <div class="form-group">
