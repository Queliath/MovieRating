...
<f:message bundle="${locale}" key="locale.noGenre" var="localeNoGenre"/>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <c:if test="${requestScope.genre != null}">
        <div class="jumbotron">
            <ul class="nav nav-tabs">
                <li <c:if test='${requestScope.editingLanguage eq "EN"}'>class="active"</c:if>><a href="Controller?command=edit-genre&id=${requestScope.genre.id}">EN</a></li>
                <li <c:if test='${requestScope.editingLanguage eq "RU"}'>class="active"</c:if>><a href="Controller?command=edit-genre&id=${requestScope.genre.id}&lang=RU">RU</a></li>
            </ul>
            <form method="post" role="form">
                ...
                <c:if test='${requestScope.editingLanguage ne "EN"}'>
                    <input name="genreFormPosition" value="${requestScope.genre.position}" type="hidden">
                </c:if>
                <div class="form-group">
