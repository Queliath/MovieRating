...
/**
 * Services the request to delete the existing relation between the movie and the country.
 *
 * @author Kostevich Vladislav
 * @version 1.0
 */
public class DeleteCountryFromMovieCommand implements Command {
    ...
    private static final String COUNTRY_ID_REQUEST_PARAM = "id";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            relationService.deleteCountryFromMovie(Integer.parseInt(movieIdParam), Integer.parseInt(countryIdParam));
